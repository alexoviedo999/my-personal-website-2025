...
import javascriptLogo from '../../public/skillslogos/javascript.svg'
...
const images = [
  // Front
  { position: [-0.45, 0.8, -0.5], rotation: [0, 0, 0], url: javascriptLogo },
  // Back
  { position: [0.6, 0.8, -0.5], rotation: [0, 0, 0], url: pexel(416430) },
  // { position: [0.8, 0, -0.6], rotation: [0, 0, 0], url: pexel(310452) },
  // Left
  { position: [-1.3, 0.8, 0.25], rotation: [0, Math.PI / 3.4, 0], url: pexel(327482) },
  // { position: [-2.15, 0, 1.5], rotation: [0, Math.PI / 2.5, 0], url: pexel(325185) },
  // { position: [-2, 0, 2.75], rotation: [0, Math.PI / 2.5, 0], url: pexel(358574) },
  // Right
  { position: [1.45, 0.8, 0.25], rotation: [0, -Math.PI / 3.4, 0], url: pexel(227675) },
